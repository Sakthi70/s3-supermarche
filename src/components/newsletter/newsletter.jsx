            ...
            <Grid item lg={6} md={6} xs={12} alignItems="center">
              <div className="content">
                ...
                <H1 fontSize={36} fontWeight={700} mb={2}>
                  Sign up to <Span color="primary.main">{appContent.appShort}</Span>
                </H1>

                <Paragraph color="grey.600" mb={5}>
                  `Subscribe to the {appContent.appName} eCommerce newsletter to receive timely updates from your
                  favorite products.`
                </Paragraph>
